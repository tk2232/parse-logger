...
const WinstonElastic = require('winston-elasticsearch').ElasticsearchTransport
...
function configureTransports(options) {
  ...
  if(!_.isNil(options.esClientOptions)) {
    const esTransportOpts = {
      level: options.level,
      clientOpts: { node: options.esClientOptions.url }
    };
